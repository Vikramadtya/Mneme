...
export function TopBar() {
  ...
  return (
    <header
      ...
      className="px-10 pt-12 pb-6 border-b border-gray-200 dark:border-white/10 bg-[#f5f5f7]/80 dark:bg-[#121212]/80 backdrop-blur-2xl sticky top-0 z-10 flex justify-between items-end transition-colors duration-300"
    >
      <div>
