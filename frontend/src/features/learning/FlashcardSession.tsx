    ...
    <div className="min-h-screen bg-slate-50 flex flex-col font-sans">
      ...
      <main className="flex-1 flex items-center justify-center p-6">
          <div className="w-full max-w-2xl perspective-1000">
              ...
              {/* Flashcard */}
              <div className={`relative w-full transition-all duration-500 transform-style-3d ${isRevealed ? 'rotate-x-180' : ''}`}>
                  
                  {/* Front */}
                  <div className={`w-full bg-white rounded-3xl p-12 md:p-16 shadow-xl shadow-slate-200/50 border border-slate-100 flex flex-col items-center justify-center text-center min-h-[400px] absolute inset-0 backface-hidden ${isRevealed ? 'opacity-0' : 'opacity-100'} transition-opacity duration-300 delay-100`}>
                  ...
                  {/* Back (Revealed) */}
                  <div className={`w-full bg-white rounded-3xl p-12 shadow-xl shadow-slate-200/50 border border-slate-100 flex flex-col justify-center min-h-[400px] relative rotate-x-180 backface-hidden ${isRevealed ? 'opacity-100' : 'opacity-0'}`}>
              ...
              <div className="mt-12 flex justify-center">
                  {!isRevealed ? (
                      ...
                      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 w-full animate-in slide-in-from-bottom-4 fade-in duration-300">
                          <button onClick={() => handleGrade(1)} className="group bg-white border border-slate-200 hover:border-red-200 hover:bg-red-50 rounded-2xl p-4 transition-all">
                          ...
                          <button onClick={() => handleGrade(2)} className="group bg-white border border-slate-200 hover:border-orange-200 hover:bg-orange-50 rounded-2xl p-4 transition-all">
                          ...
                          <button onClick={() => handleGrade(3)} className="group bg-white border border-slate-200 hover:border-blue-200 hover:bg-blue-50 rounded-2xl p-4 transition-all">
                          ...
                          <button onClick={() => handleGrade(4)} className="group bg-white border border-slate-200 hover:border-emerald-200 hover:bg-emerald-50 rounded-2xl p-4 transition-all">
