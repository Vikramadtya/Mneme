...
<div class="cards-grid">
  <div class="card">
    ...
    <p>The structural core of software. BFS, DFS, and DP.</p>
    <a href="/Algorithmic Pattern/index">Entry →</a>
  </div>
  <div class="card">
    <h3>🏗️ Design Patterns</h3>
    <p>Architectural blueprints for clean, scalable code.</p>
    <a href="/Low Level Design/index">Entry →</a>
  </div>
  <div class="card">
    <h3>🌐 System Design</h3>
    <p>Distributed systems, sharding, and high availability.</p>
    <a href="/System Design/0. About">Entry →</a>
  </div>
  <div class="card">
    <h3>💻 Coding Solutions</h3>
    <p>Practical problem solving for real-world scenarios.</p>
    <a href="/Code Scratch/index">Entry →</a>
  </div>
</div>
